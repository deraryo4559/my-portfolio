...
ディレクションから納品までトータルサポート。`,features:["事前打ち合わせ","モデル・スタジオ手配","高度なレタッチ","著作権譲渡可"]}],yU=[{q:"納品までの期間はどのくらいですか？",a:"通常、撮影日から2週間程度いただいております。お急ぎの場合はオプションにて対応可能です。"},{q:"撮影場所の指定は可能ですか？",a:"はい、可能です。東京都内であれば出張費は無料ですが、遠方の場合は別途交通費を頂戴しております。"},{q:"衣装やメイクの手配はできますか？",a:"提携しているスタイリスト、ヘアメイクアップアーティストをご紹介可能です（別途費用）。"},{q:"雨天の場合はどうなりますか？",a:"屋内の場合は決行いたします。屋外撮影の場合は、前日の天気予報で判断し、日程変更を無料で承ります。"}],SU=({onSelectWork:t})=>{const[e,n]=le.useState("All"),i=e==="All"?av:av.filter(r=>r.category===e);return M.jsxs("div",{className:"py-20 px-6 container mx-auto",children:[M.jsx(zi,{children:M.jsxs("div",{className:"flex flex-col md:flex-row justify-between items-end mb-16 gap-8",children:[M.jsxs("div",{children:[M.jsx("h2",{className:"text-5xl md:text-6xl font-serif text-white mb-4",children:"Works"}),M.jsx("p",{className:"text-zinc-500 text-sm tracking-[0.2em]",children:"Selected Portfolio 2024-2025"})]}),M.jsx("div",{className:"flex flex-wrap gap-4",children:["All","Portrait","Cityscape","Nature","Commercial"].map(r=>M.jsx("button",{onClick:()=>n(r),className:`text-xs uppercase tracking-wider px-3 py-1 border transition-all duration-300 ${e===r?"border-white text-white":"border-transparent text-zinc-600 hover:text-zinc-400"}`,children:r},r))})]})}),M.jsx("div",{className:"columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8",children:i.map((r,s)=>M.jsx(zi,{delay:s*100,className:"break-inside-avoid",children:M.jsx("div",{onClick:()=>t(r),children:M.jsx(UI,{className:"group cursor-pointer relative",children:M.jsxs("div",{className:"w-full relative overflow-hidden rounded-sm",children:[M.jsx("img",{src:r.image,alt:r.title,className:`w-full ${r.height} object-cover transition-transform duration-700 group-hover:scale-110`,loading:"lazy"}),M.jsx("div",{className:"absolute inset-0 bg-black/20 group-hover:bg-black/0 transition-colors duration-500"}),M.jsxs("div",{className:"absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6",children:[M.jsx("span",{className:"text-xs text-zinc-400 uppercase tracking-widest mb-1 translate-y-4 group-hover:translate-y-0 transition-transform duration-300",children:r.category}),M.jsx("h3",{className:"text-xl font-serif text-white translate-y-4 group-hover:translate-y-0 transition-transform duration-300 delay-75",children:r.title})]})]})})})},r.id))})]})},MU=({title:t,subtitle:e})=>M.jsxs("div",{className:"text-center mb-16",children:[M.jsx("h2",{className:"text-5xl md:text-6xl font-serif text-white mb-4",children:t}),M.jsx("p",{className:"text-zinc-500 text-sm tracking-[0.2em] uppercase",children:e})]}),EU=({q:t,a:e})=>{const[n,i]=le.useState(!1);return M.jsxs("div",{className:"border-b border-zinc-800",children:[M.jsxs("button",{onClick:()=>i(!n),className:"w-full py-6 flex justify-between items-center text-left hover:text-white transition-colors group",children:[M.jsx("span",{className:`text-lg font-light ${n?"text-white":"text-zinc-400"}`,children:t}),M.jsx(nT,{size:20,className:`text-zinc-600 transition-transform duration-300 ${n?"rotate-45 text-white":""}`})]}),M.jsx("div",{className:`overflow-hidden transition-all duration-300 ${n?"max-h-40 opacity-100 mb-6":"max-h-0 opacity-0"}`,children:M.jsx("p",{className:"text-zinc-500 text-sm leading-relaxed pr-8 pl-4 border-l border-zinc-800 ml-1",children:e})})]})},TU=({onNavigate:t})=>M.jsxs("div",{className:"py-20 px-6 container mx-auto max-w-5xl",children:[M.jsx(zi,{children:M.jsx(MU,{title:"Service",subtitle:"撮影プラン・料金"})}),M.jsx("div",{className:"grid md:grid-cols-3 gap-6 mb-32",children:_U.map((e,n)=>M.jsx(zi,{delay:n*150,className:"h-full",children:M.jsxs("div",{className:"relative p-8 border border-zinc-800 hover:border-zinc-600 transition-colors duration-500 flex flex-col h-full group bg-zinc-900/30 backdrop-blur-sm",children:[M.jsx("div",{className:"absolute top-0 right-0 w-16 h-16 bg-gradient-to-bl from-white/5 to-transparent -z-10 group-hover:from-white/10 transition-colors"}),M.jsx("h3",{className:"text-xl font-serif text-white mb-4",children:e.title}),M.jsx("div",{className:"text-2xl font-light text-zinc-200 mb-6",children:e.price}),M.jsx("p",{className:"text-zinc-400 text-sm leading-relaxed mb-8 whitespace-pre-line flex-grow",children:e.description}),M.jsx("ul",{className:"space-y-3 pt-6 border-t border-zinc-800",children:e.features.map((i,r)=>M.jsxs("li",{className:"text-zinc-500 text-xs flex items-center gap-2",children:[M.jsx("div",{className:"w-1 h-1 bg-zinc-400 rounded-full"}),i]},r))}),M.jsx("button",{onClick:()=>t("contact"),className:"mt-8 w-full py-3 border border-zinc-700 text-zinc-400 text-xs tracking-widest hover:bg-white hover:text-black hover:border-white transition-all duration-300",children:"BOOK NOW"})]})},n))}),M.jsx(zi,{delay:400,children:M.jsxs("div",{className:"grid md:grid-cols-2 gap-16",children:[M.jsxs("div",{children:[M.jsx("h3",{className:"text-2xl font-serif text-white mb-8",children:"FAQ"}),M.jsx("p",{className:"text-zinc-500 text-sm mb-8",children:"よくいただくご質問をまとめました。"})]}),M.jsx("div",{children:yU.map((e,n)=>M.jsx(EU,{q:e.q,a:e.a},n))})]})})]}),wU=({onSelectNews:t})=>M.jsxs("div",{className:"py-20 px-6 container mx-auto max-w-4xl",children:[M.jsx(zi,{children:M.jsxs("div",{className:"flex items-end gap-6 mb-20 border-b border-zinc-800 pb-8",children:[M.jsx("h2",{className:"text-5xl font-serif text-white",children:"News"}),M.jsx("span",{className:"text-zinc-500 text-sm tracking-widest pb-2",children:"/ ARCHIVE"})]})}),M.jsx("div",{className:"space-y-0",children:vU.map((e,n)=>M.jsx(zi,{delay:n*100,children:M.jsx("div",{onClick:()=>t(e),className:"group relative border-b border-zinc-800 py-10 cursor-pointer hover:bg-zinc-900/30 transition-colors duration-500",children:M.jsxs("div",{className:"flex flex-col md:flex-row md:items-baseline gap-6 relative z-10 px-4",children:[M.jsx("div",{className:"w-32 flex-shrink-0",children:M.jsx("span",{className:"text-xs font-mono text-zinc-500 group-hover:text-white transition-colors",children:e.date})}),M.jsxs("div",{className:"flex-grow",children:[M.jsx("div",{className:"flex items-center gap-4 mb-2",children:M.jsx("span",{className:"text-[10px] uppercase tracking-wider border border-zinc-800 text-zinc-500 px-2 py-0.5 rounded-full group-hover:border-zinc-600 transition-colors",children:e.category})}),M.jsx("h3",{className:"text-2xl font-serif text-zinc-300 group-hover:text-white transition-colors duration-300",children:e.title}),M.jsx("p",{className:"text-zinc-500 text-sm mt-4 line-clamp-2 md:w-2/3 group-hover:text-zinc-400 transition-colors",children:e.content})]}),M.jsx("div",{className:"hidden md:block opacity-0 group-hover:opacity-100 -translate-x-4 group-hover:translate-x-0 transition-all duration-300",children:M.jsx("div",{className:"w-10 h-10 rounded-full border border-zinc-700 flex items-center justify-center",children:M.jsx(LE,{size:16,className:"text-white"})})})]})})},e.id))})]}),bU=()=>M.jsx("div",{className:"py-20 px-6 container mx-auto max-w-6xl",children:M.jsxs("div",{className:"grid md:grid-cols-2 gap-20",children:[M.jsx(zi,{children:M.jsxs("div",{children:[M.jsx("h2",{className:"text-5xl font-serif text-white mb-8",children:"Contact"}),M.jsxs("p",{className:"text-zinc-400 text-sm leading-loose mb-12",children:["撮影のご依頼、お見積もり、その他ご質問など",M.jsx("br",{}),"お気軽にお問い合わせください。",M.jsx("br",{}),"3営業日以内に返信いたします。"]}),M.jsxs("div",{className:"space-y-6",children:[M.jsxs("div",{className:"flex items-center gap-4 text-zinc-400",children:[M.jsx(XE,{className:"text-zinc-600"}),M.jsx("span",{children:"contact@k-photo.com"})]}),M.jsxs("div",{className:"flex items-center gap-4 text-zinc-400",children:[M.jsx(KE,{className:"text-zinc-600"}),M.jsx("span",{children:"Tokyo, Japan"})]}),M.jsxs("div",{className:"pt-8 flex gap-6",children:[M.jsx("a",{href:"#",className:"text-zinc-600 hover:text-white transition-colors",children:M.jsx(WE,{size:24})}),M.jsx("a",{href:"#",className:"text-zinc-600 hover:text-white transition-colors",children:M.jsx(oT,{size:24})})]})]})]})}),M.jsx(zi,{delay:200,children:M.jsx("div",{className:"bg-zinc-900/20 p-8 md:p-12 border border-zinc-800",children:M.jsxs("form",{className:"space-y-10",onSubmit:t=>t.preventDefault(),children:[M.jsxs("div",{className:"relative group",children:[M.jsx("input",{type:"text",id:"name",required:!0,className:"w-full bg-transparent border-b border-zinc-700 py-3 text-white focus:outline-none focus:border-white transition-colors peer",placeholder:" "}),M.jsx("label",{htmlFor:"name",className:"absolute left-0 top-3 text-zinc-500 text-xs uppercase tracking-widest transition-all peer-focus:-top-4 peer-focus:text-xs peer-placeholder-shown:top-3 peer-placeholder-shown:text-sm cursor-text pointer-events-none",children:"Name"})]}),M.jsxs("div",{className:"relative group",children:[M.jsx("input",{type:"email",id:"email",required:!0,className:"w-full bg-transparent border-b border-zinc-700 py-3 text-white focus:outline-none focus:border-white transition-colors peer",placeholder:" "}),M.jsx("label",{htmlFor:"email",className:"absolute left-0 top-3 text-zinc-500 text-xs uppercase tracking-widest transition-all peer-focus:-top-4 peer-focus:text-xs peer-placeholder-shown:top-3 peer-placeholder-shown:text-sm cursor-text pointer-events-none",children:"Email"})]}),M.jsxs("div",{className:"relative group",children:[M.jsx("textarea",{id:"message",rows:4,required:!0,className:"w-full bg-transparent border-b border-zinc-700 py-3 text-white focus:outline-none focus:border-white transition-colors peer resize-none",placeholder:" "}),M.jsx("label",{htmlFor:"message",className:"absolute left-0 top-3 text-zinc-500 text-xs uppercase tracking-widest transition-all peer-focus:-top-4 peer-focus:text-xs peer-placeholder-shown:top-3 peer-placeholder-shown:text-sm cursor-text pointer-events-none",children:"Message"})]}),M.jsx("button",{className:"w-full bg-white text-black py-4 font-medium tracking-widest hover:bg-zinc-200 transition-all transform hover:scale-[1.01] duration-300",children:"SEND MESSAGE"})]})})})]})}),AU=({onNavigate:t})=>{const e=[{icon:M.jsx(zE,{className:"w-6 h-6 text-purple-400"}),title:"Emotion",description:"被写体の内面にある感情や物語を、一瞬の表情から引き出します。"},{icon:M.jsx(bE,{className:"w-6 h-6 text-pink-400"}),title:"Light",description:"自然光と人工光を巧みに操り、ドラマチックで印象的な空間を演出します。"},{icon:M.jsx(HE,{className:"w-6 h-6 text-purple-400"}),title:"Moment",description:"二度と訪れない「その瞬間」を、永遠の記憶として定着させます。"}];return M.jsx("div",{className:"min-h-screen bg-black text-white pt-24 pb-20 px-6",children:M.jsxs("div",{className:"max-w-6xl mx-auto",children:[M.jsxs(Ft.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},className:"mb-20 text-center",children:[M.jsx(za,{className:"w-16 h-16 mx-auto mb-6 text-purple-500 opacity-80"}),M.jsx("h1",{className:"text-4xl md:text-7xl font-serif font-medium mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-600 italic",children:"Photography"}),M.jsxs("p",{className:"text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed font-light",children:["言葉にできない感情を、光と影で紡ぐ。",M.jsx("br",{}),"ポートレートから風景まで、心を揺さぶるビジュアルストーリーテリング。"]})]}),M.jsx("div",{className:"grid md:grid-cols-3 gap-12 mb-32",children:e.map((n,i)=>M.jsxs(Ft.div,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},transition:{delay:i*.1},viewport:{once:!0},className:"text-center",children:[M.jsx("div",{className:"inline-flex items-center justify-center w-16 h-16 rounded-full bg-purple-900/30 mb-6 border border-purple-500/20",children:n.icon}),M.jsx("h3",{className:"text-2xl font-serif mb-4 text-purple-100",children:n.title}),M.jsx("p",{className:"text-zinc-400 leading-relaxed font-light",children:n.description})]},i))}),M.jsxs("div",{className:"mb-20",children:[M.jsx("h2",{className:"text-3xl font-serif mb-12 border-l-4 border-purple-500 pl-6 italic",children:"Featured Works"}),M.jsx("div",{className:"grid grid-cols-2 md:grid-cols-3 gap-4",children:[1,2,3,4,5,6].map(n=>M.jsxs("div",{className:`relative bg-zinc-800 rounded overflow-hidden group cursor-pointer ${n===2||n===5?"md:col-span-2":""} ${n%2===0?"h-64":"h-80"}`,children:[M.jsxs("div",{className:"absolute inset-0 flex items-center justify-center text-zinc-600",children:["Image ",n]}),M.jsx("div",{className:"absolute inset-0 bg-purple-900/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500"})]},n))})]}),M.jsx("div",{className:"text-center",children:M.jsx("button",{onClick:()=>t("contact"),className:"bg-purple-600 hover:bg-purple-500 text-white px-10 py-4 rounded-sm font-serif tracking-widest transition-all hover:scale-105",children:"撮影を依頼する"})})]})})},CU=({onNavigate:t})=>{const e=le.useRef(null),{scrollYProgress:n}=AI({target:e}),i=sv(n,[0,.2],[1,0]),r=sv(n,[0,.2],[1,.95]),s=[{id:"01",title:"Reconstructing Reality",subtitle:"AI Object Removal / Generative Fill",description:"写真は「引き算」の芸術だと言われます。AIによる生成塗りつぶし技術（Generative Fill）は、その引き算を極限まで精密にします。風景に紛れ込んだノイズを取り除き、私が心で見た「理想の景色」を忠実に再現する。それは改変ではなく、記憶の現像です。",icon:M.jsx(lT,{className:"w-6 h-6"}),image:"https://images.unsplash.com/photo-1518066000714-58c45f1a2c0a?q=80&w=2070&auto=format&fit=crop",color:"from-emerald-500/20 to-teal-500/20"},{id:"02",title:"Decoding Aesthetics",subtitle:"Style Analysis / Computer Vision",description:"なぜ、その写真は美しいのか。構図、色彩、光のバランス。AI画像解析アルゴリズムを用いて、名作と呼ばれる写真の構造を数値化・言語化します。感性をデータとして客観視することで、自身のスタイルをより深く理解し、意図的な表現へと昇華させます。",icon:M.jsx(kE,{className:"w-6 h-6"}),image:"https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=2070&auto=format&fit=crop",color:"from-blue-500/20 to-indigo-500/20"},{id:"03",title:"Extended Perception",subtitle:"AI Gimbal / Autonomous Tracking",description:"機械の目は、人の身体性を拡張します。自律制御AIを搭載したジンバルシステムは、被写体の動きを予測し、人間には不可能な滑らかさと正確さで追従します。撮影者は操作から解放され、被写体との対話、そして「一瞬」を捉えることだけに集中できます。",icon:M.jsx(rT,{className:"w-6 h-6"}),image:"https://images.unsplash.com/photo-1535378437323-9555f3e7f667?q=80&w=1932&auto=format&fit=crop",color:"from-purple-500/20 to-pink-500/20"}];return M.jsxs("div",{ref:e,className:"min-h-screen bg-zinc-950 text-zinc-200 selection:bg-emerald-500/30",children:[M.jsxs("div",{className:"fixed inset-0 pointer-events-none",children:[M.jsx("div",{className:"absolute top-0 left-0 w-full h-full bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-20"}),M.jsx("div",{className:"absolute top-1/4 left-1/4 w-96 h-96 bg-emerald-500/10 rounded-full blur-3xl animate-pulse-slow"}),M.jsx("div",{className:"absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl animate-pulse-slow animation-delay-400"})]}),M.jsxs("nav",{className:"fixed top-0 left-0 w-full p-6 z-50 flex justify-between items-center mix-blend-difference",children:[M.jsxs("button",{onClick:()=>t("home"),className:"group flex items-center gap-3 text-sm font-medium tracking-widest text-zinc-400 hover:text-white transition-colors",children:[M.jsx("div",{className:"p-2 border border-zinc-700 rounded-full group-hover:border-white transition-colors",children:M.jsx(PE,{size:14})}),M.jsx("span",{children:"HOME"})]}),M.jsxs("div",{className:"flex items-center gap-2 text-xs font-mono text-zinc-500",children:[M.jsx(Rd,{size:12,className:"text-emerald-500"}),M.jsx("span",{children:"AI_MODULE_ACTIVE"})]})]}),M.jsxs(Ft.section,{style:{opacity:i,scale:r},className:"h-screen flex flex-col items-center justify-center relative px-6 overflow-hidden",children:[M.jsx("div",{className:"absolute inset-0 z-0 opacity-30",children:M.jsxs("svg",{className:"w-full h-full",viewBox:"0 0 100 100",preserveAspectRatio:"none",children:[M.jsx(Ft.path,{d:"M0,50 Q25,40 50,50 T100,50",stroke:"rgba(16, 185, 129, 0.2)",strokeWidth:"0.5",fill:"none",animate:{d:["M0,50 Q25,40 50,50 T100,50","M0,50 Q25,60 50,50 T100,50","M0,50 Q25,40 50,50 T100,50"]},transition:{duration:10,repeat:1/0,ease:"linear"}}),M.jsx(Ft.path,{d:"M0,50 Q25,30 50,50 T100,50",stroke:"rgba(59, 130, 246, 0.2)",strokeWidth:"0.5",fill:"none",animate:{d:["M0,50 Q25,30 50,50 T100,50","M0,50 Q25,70 50,50 T100,50","M0,50 Q25,30 50,50 T100,50"]},transition:{duration:15,repeat:1/0,ease:"linear"}})]})}),M.jsx("div",{className:"relative z-10 text-center max-w-4xl mx-auto",children:M.jsxs(Ft.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8},children:[M.jsxs("h1",{className:"text-5xl md:text-8xl font-serif font-bold tracking-tight mb-8",children:[M.jsx("span",{className:"block text-transparent bg-clip-text bg-gradient-to-r from-zinc-200 via-zinc-500 to-zinc-200",children:"Co-Creation"}),M.jsx("span",{className:"block text-4xl md:text-6xl font-light italic text-zinc-400 mt-2",children:"with Intelligence"})]}),M.jsxs("p",{className:"text-sm md:text-base text-zinc-500 font-mono tracking-wider max-w-lg mx-auto leading-relaxed",children:["> INTEGRATING_NEURAL_NETWORKS",M.jsx("br",{}),"> EXPANDING_CREATIVE_BOUNDARIES"]})]})}),M.jsxs(Ft.div,{initial:{opacity:0},animate:{opacity:1},transition:{delay:1,duration:1},className:"absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4",children:[M.jsx("div",{className:"w-[1px] h-16 bg-gradient-to-b from-transparent via-emerald-500 to-transparent animate-pulse"}),M.jsx("span",{className:"text-[10px] tracking-[0.3em] text-emerald-500/60 uppercase",children:"Explore Projects"})]})]}),M.jsx("div",{className:"relative z-10 pb-40",children:s.map((o,a)=>M.jsx("section",{className:"min-h-screen flex items-center py-20 px-6 md:px-12 sticky top-0 bg-zinc-950/90 backdrop-blur-sm border-t border-white/5",children:M.jsxs("div",{className:"max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-16 items-center",children:[M.jsx(Ft.div,{initial:{opacity:0,x:-50,filter:"blur(10px)"},whileInView:{opacity:1,x:0,filter:"blur(0px)"},transition:{duration:.8,ease:"easeOut"},viewport:{once:!0,margin:"-10%"},className:`order-2 ${a%2===0?"md:order-2":"md:order-1"} relative group`,children:M.jsxs("div",{className:"relative aspect-[4/3] overflow-hidden rounded-sm",children:[M.jsx("div",{className:`absolute inset-0 bg-gradient-to-br ${o.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10 mix-blend-overlay`}),M.jsx("img",{src:o.image,alt:o.title,className:"w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 grayscale group-hover:grayscale-0"}),M.jsx("div",{className:"absolute bottom-4 left-4 z-20 flex items-center gap-2",children:M.jsxs("div",{className:"px-2 py-1 bg-black/50 backdrop-blur-md border border-white/10 text-[10px] font-mono text-emerald-400",children:["IMG_0",a+1,".RAW"]})}),M.jsxs("div",{className:"absolute inset-0 border border-white/10 z-20 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300",children:[M.jsx("div",{className:"absolute top-0 left-0 w-4 h-4 border-t border-l border-emerald-500"}),M.jsx("div",{className:"absolute top-0 right-0 w-4 h-4 border-t border-r border-emerald-500"}),M.jsx("div",{className:"absolute bottom-0 left-0 w-4 h-4 border-b border-l border-emerald-500"}),M.jsx("div",{className:"absolute bottom-0 right-0 w-4 h-4 border-b border-r border-emerald-500"})]})]})}),M.jsx("div",{className:`order-1 ${a%2===0?"md:order-1":"md:order-2"} space-y-8`,children:M.jsxs(Ft.div,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},transition:{duration:.6,delay:.2},viewport:{once:!0},children:[M.jsxs("div",{className:"flex items-center gap-4 mb-6",children:[M.jsx("span",{className:"text-4xl font-serif text-white/10 font-bold",children:o.id}),M.jsx("div",{className:"h-[1px] flex-1 bg-white/10"}),M.jsx("div",{className:"text-zinc-500",children:o.icon})]}),M.jsx("h2",{className:"text-3xl md:text-5xl font-serif font-medium text-white mb-4",children:o.title}),M.jsx("p",{className:"text-emerald-500 text-xs md:text-sm tracking-[0.2em] uppercase mb-8 font-mono",children:o.subtitle}),M.jsx("p",{className:"text-zinc-400 leading-loose font-light text-base md:text-lg",children:o.description}),M.jsx("div",{className:"pt-8",children:M.jsxs("button",{className:"text-xs tracking-widest uppercase text-zinc-500 hover:text-white transition-colors flex items-center gap-2 group",children:[M.jsx("span",{children:"View Details"}),M.jsx("div",{className:"w-8 h-[1px] bg-zinc-700 group-hover:bg-white transition-colors"})]})})]})})]})},o.id))}),M.jsx("section",{className:"py-32 px-6 text-center border-t border-white/5 bg-zinc-950 relative overflow-hidden",children:M.jsxs("div",{className:"max-w-2xl mx-auto relative z-10",children:[M.jsx(Rd,{className:"w-12 h-12 mx-auto mb-8 text-zinc-800",strokeWidth:1}),M.jsxs("p",{className:"text-zinc-500 leading-relaxed font-serif italic text-xl",children:['"AI is not about replacing the artist,',M.jsx("br",{}),`it's about unleashing the imagination."`]})]})})]})},RU=({work:t,onClose:e})=>t?M.jsxs("div",{className:"fixed inset-0 z-[60] bg-zinc-950/95 flex items-center justify-center p-4 md:p-12 animate-fade-in",onClick:e,children:[M.jsx("button",{onClick:e,className:"absolute top-6 right-6 text-white hover:rotate-90 transition-transform duration-300",children:M.jsx(Fp,{size:32})}),M.jsxs("div",{className:"flex flex-col md:flex-row gap-12 max-w-7xl w-full h-full md:h-auto items-center",onClick:n=>n.stopPropagation(),children:[M.jsxs("div",{className:"w-full md:w-2/3 h-[50vh] md:h-[80vh] relative shadow-2xl overflow-hidden rounded-sm group",children:[M.jsx("img",{src:t.image,alt:t.title,className:"w-full h-full object-cover"}),M.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-black/40 to-transparent"})]}),M.jsxs("div",{className:"w-full md:w-1/3 text-white space-y-8 animate-fade-in-up",children:[M.jsxs("div",{children:[M.jsx("p",{className:"text-zinc-500 text-sm tracking-widest uppercase mb-2",children:t.category}),M.jsx("h2",{className:"text-4xl md:text-5xl font-serif mb-6",children:t.title}),M.jsx("p",{className:"text-zinc-400 leading-relaxed font-light",children:t.description})]}),M.jsxs("div",{className:"border-t border-zinc-800 pt-8 space-y-4 text-sm font-mono text-zinc-500",children:[M.jsxs("div",{className:"flex justify-between items-center",children:[M.jsxs("span",{className:"flex items-center gap-2",children:[M.jsx(UE,{size:14})," Date"]})," ",M.jsx("span",{className:"text-zinc-300",children:t.date})]}),M.jsxs("div",{className:"flex justify-between items-center",children:[M.jsxs("span",{className:"flex items-center gap-2",children:[M.jsx(za,{size:14})," Gear"]})," ",M.jsx("span",{className:"text-zinc-300",children:t.equipment})]}),M.jsxs("div",{className:"flex justify-between items-center",children:[M.jsxs("span",{className:"flex items-center gap-2",children:[M.jsx(YE,{size:14})," Location"]})," ",M.jsx("span",{className:"text-zinc-300",children:t.location})]})]})]})]})]}):null,PU=({news:t,onClose:e})=>t?M.jsx("div",{className:"fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/90 backdrop-blur-sm transition-all animate-fade-in",onClick:e,children:M.jsxs("div",{className:"bg-zinc-900 border border-zinc-800 w-full max-w-lg p-8 rounded-sm relative",onClick:n=>n.stopPropagation(),children:[M.jsx("button",{onClick:e,className:"absolute top-4 right-4 text-zinc-500 hover:text-white",children:M.jsx(Fp,{})}),M.jsx("span",{className:"text-xs text-zinc-500 border border-zinc-800 px-2 py-1 rounded mb-4 inline-block",children:t.category}),M.jsx("div",{className:"text-sm font-mono text-zinc-500 mb-2",children:t.date}),M.jsx("h3",{className:"text-2xl font-serif text-white mb-6",children:t.title}),M.jsx("p",{className:"text-zinc-300 text-sm leading-loose whitespace-pre-wrap",children:t.content})]})}):null;function DU(){const[t,e]=le.useState("home"),[n,i]=le.useState(null),[r,s]=le.useState(null);return le.useEffect(()=>{window.scrollTo(0,0)},[t]),M.jsx(gE,{children:M.jsxs("div",{className:"min-h-screen bg-zinc-950 text-zinc-200 font-sans selection:bg-white selection:text-black overflow-x-hidden",children:[t!=="home"&&M.jsx(vE,{}),M.jsx(_E,{}),M.jsx(dT,{currentPage:t,onNavigate:e}),M.jsxs("main",{className:"pt-20 min-h-screen relative z-10",children:[t==="home"&&M.jsx(II,{onNavigate:e}),t==="works"&&M.jsx(SU,{onSelectWork:s}),t==="service"&&M.jsx(TU,{onNavigate:e}),t==="news"&&M.jsx(wU,{onSelectNews:i}),t==="contact"&&M.jsx(bU,{}),t==="photographer"&&M.jsx(AU,{onNavigate:e}),t==="ai-photographer"&&M.jsx(CU,{onNavigate:e})]}),t!=="home"&&M.jsx(hT,{onNavigate:e}),M.jsx(RU,{work:r,onClose:()=>s(null)}),M.jsx(PU,{news:n,onClose:()=>i(null)}),M.jsx("style",{children:`
        ...
        `})]})})}Ff.createRoot(document.getElementById("root")).render(M.jsx(vv.StrictMode,{children:M.jsx(DU,{})}));
