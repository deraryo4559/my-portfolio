...
#endif`,x2="gl_FragColor = linearToOutputTexel( gl_FragColor );",g2=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
場所：青山Blue Gallery`},{id:2,date:"2025.10.15",category:"Work",title:"雑誌「Life & Light」11月号 表紙撮影",content:"光の表現について特集された今月号にて、表紙写真と巻頭インタビューを担当させていただきました。全国の書店にて発売中です。"},{id:3,date:"2025.09.01",category:"Info",title:"Webサイトリニューアル",content:"より作品の世界観をお伝えできるよう、ポートフォリオサイトを一新いたしました。"}],av=[{id:1,title:"Ethereal Dawn",category:"Nature",image:FI,height:"h-96",date:"2025.04",equipment:"LUMIX S5",location:"Nagano, Japan",description:"雲海の上、世界が目覚める瞬間。黄金色の光が霧を染め上げ、静寂と躍動が交差する。ドローンによる高度150mからの視点は、地上では決して見ることのできない地球の鼓動を捉えている。光の階調（グラデーション）を最大限に残すため、早朝のマジックアワーに撮影。"},{id:2,title:"Urban Vertigo",category:"Cityscape",image:OI,height:"h-64",date:"2024.11",equipment:"LUMIX S5",location:"Tokyo, Shinjuku",description:"コンクリートジャングルの谷底から見上げる空。無機質なビル群の反射と、切り取られた青空の対比。都市の冷たさの中にある幾何学的な美しさを表現。広角レンズ特有のパースペクティブを活かし、圧倒的な没入感を目指した。"},{id:3,title:"Silent Portrait",category:"Portrait",image:kI,height:"h-[500px]",date:"2025.02",equipment:"LUMIX S5",location:"Kyoto",description:"被写体の内面にある静けさを引き出す。余計な演出を排し、自然光のみで撮影。瞳の奥にある物語を想像させるような、普遍的な強さを持つポートレート。背景のボケ味（Bokhe）が、被写体の存在感をより一層際立たせている。"},{id:4,title:"Neon Reflections",category:"Cityscape",image:BI,height:"h-72",date:"2025.01",equipment:"LUMIX S5",location:"Osaka, Dotonbori",description:"雨上がりの路面に反射するネオンサイン。色彩の洪水が、夜の街をサイバーパンクな世界へと変える。長時間露光ではなく、高感度撮影によって通行人のシルエットを意図的にブラし、街の「動き」と「熱量」を一枚に閉じ込めた。"},{id:5,title:"Minimalist Sea",category:"Nature",image:zI,height:"h-80",date:"2024.12",equipment:"LUMIX S5",location:"Okinawa",description:"エメラルドグリーンの海と、白い砂浜。ただそれだけのシンプルな構図。ドローンの真俯瞰撮影（トップダウンビュー）により、自然が作り出す抽象画のような美しさを発見。波のテクスチャと色のグラデーションが、見る者の心を浄化する。"},{id:6,title:"The Architect",category:"Commercial",image:VI,height:"h-64",date:"2025.05",equipment:"LUMIX S5",location:"Tokyo, Ginza",description:"現代建築の鋭利なラインとガラスの反射。建築家の意図したデザインを忠実に再現しつつ、光の当たり方によって生まれる新たな表情を切り取る。シフトレンズを使用し、歪みのない垂直水平な構図を実現。"},{id:7,title:"Deep Forest",category:"Nature",image:HI,height:"h-[400px]",date:"2024.08",equipment:"LUMIX S5",location:"Yakushima",description:"太古の記憶を宿す森。苔の緑の深さと、木漏れ日のコントラスト。湿潤な空気感まで写し撮ることを意識した。シャッタースピードを遅くすることで、川の流れを絹のように滑らかに表現し、時間の流れを可視化している。"},{id:8,title:"Street Snap",category:"Cityscape",image:GI,height:"h-80",date:"2024.10",equipment:"LUMIX S5",location:"Shibuya",description:"雑踏の中の一瞬のドラマ。偶然と必然が重なる瞬間を、スナップシューターで切り取る。モノクロームにすることで、色彩情報を排除し、被写体の形と光の陰影のみにフォーカスさせた。"},{id:9,title:"Blue Hour",category:"Cityscape",image:WI,height:"h-64",date:"2024.09",equipment:"LUMIX S5",location:"Yokohama",description:"日没直後の数分間、空が深い青に染まるマジックアワー。都市の灯りがともり始め、空の青と照明の暖色が美しい調和を生む。水面の反射を利用し、シンメトリーな構図で静謐な夜の始まりを表現。"},{id:10,title:"Winter Silence",category:"Nature",image:jI,height:"h-96",date:"2025.01",equipment:"LUMIX S5",location:"Hokkaido",description:"一面の雪景色。音のない世界。ミニマリズムを極めた白いキャンバスに、一本の木が影を落とす。余白の美学（Negative Space）を意識し、見る人の想像力を掻き立てる構図に仕上げた。"},{id:11,title:"Future Vision",category:"Commercial",image:XI,height:"h-72",date:"2025.03",equipment:"LUMIX S5",location:"Studio",description:"テクノロジー企業のブランディングビジュアル。LEDライティングとスモークを使用し、近未来的で革新的なイメージを演出。AI技術と人間の共存をテーマにした、コンセプチュアルな作品。"},{id:12,title:"In The Air",category:"Nature",image:qI,height:"h-64",date:"2024.07",equipment:"LUMIX S5",location:"Mt. Fuji",description:"雲を突き抜けた先にある絶景。富士山の火口を至近距離から捉えた迫力の一枚。航空法に基づき、特別な許可を得て撮影。自然の畏怖と美しさを同時に感じさせる、圧倒的なスケール感。"},{id:13,title:"Sunset Silhouette",category:"Portrait",image:YI,height:"h-[450px]",date:"2024.08",equipment:"LUMIX S5",location:"Shonan",description:"夕日を背にしたシルエットポートレート。逆光を利用し、人物の輪郭を黄金色のラインライトで縁取る。表情は見えなくとも、その佇まいから感情が伝わるような、ドラマチックな一枚。"},{id:14,title:"Industrial Light",category:"Cityscape",image:$I,height:"h-80",date:"2024.12",equipment:"LUMIX S5",location:"Kawasaki",description:"工場夜景。複雑に絡み合うパイプと、無骨な鉄骨。そこから漏れる蒸気と照明が、SF映画のようなディストピア感を演出する。金属の質感と光の光芒（ウニ）をシャープに描写。"},{id:15,title:"Flower macro",category:"Nature",image:KI,height:"h-64",date:"2025.04",equipment:"LUMIX S5",location:"Garden",description:"肉眼では見えないミクロの世界。花弁の質感、水滴の輝き。マクロレンズを用いて、生命の繊細なディテールを拡大。自然界のデザインの美しさに改めて気づかされる作品。"},{id:16,title:"Midnight Rain",category:"Cityscape",image:ZI,height:"h-80",date:"2025.02",equipment:"LUMIX S5",location:"Tokyo, Shibuya",description:"真夜中の雨音。アスファルトに反射するテールランプの赤と、信号機の青。濡れた地面の質感（Texture）と、孤独な通行人の対比。映画「ブレードランナー」のような退廃的かつ美しい世界観をスナップ。"},{id:17,title:"Serenity",category:"Portrait",image:QI,height:"h-96",date:"2024.11",equipment:"LUMIX S5",location:"Kamakura",description:"海辺の古い家屋でのポートレート。障子越しの柔らかい光（Diffused Light）が、肌の質感を滑らかに描写。静寂の中で時間が止まったような、懐かしくも新しい空気感を表現。"},{id:18,title:"The Peak",category:"Nature",image:JI,height:"h-64",date:"2025.01",equipment:"LUMIX S5",location:"Nagano, Alps",description:"北アルプスの山頂付近。氷点下20度の世界。風紋（シュカブラ）が描く雪の波模様を真上から撮影。自然が作り出す幾何学模様の美しさと、厳冬期の張り詰めた空気感をドローンで記録。"},{id:19,title:"Fashion Noir",category:"Commercial",image:eU,height:"h-[500px]",date:"2025.03",equipment:"LUMIX S5",location:"Studio B",description:"ハイブランドのキャンペーンビジュアル。黒バックに黒の衣装。素材の違い（レザー、シルク、ベルベット）をライティングのみで描き分ける挑戦。究極のモノトーン表現。"},{id:20,title:"Coffee Break",category:"Commercial",image:tU,height:"h-72",date:"2024.10",equipment:"LUMIX S5",location:"Cafe",description:"カフェのブランディングフォト。湯気、窓からの木漏れ日、使い込まれたテーブルの質感。シズル感（Sizzle）を大切にしつつ、日常の豊かな時間を切り取るライフスタイル写真。"},{id:21,title:"Autumn Colors",category:"Nature",image:nU,height:"h-64",date:"2024.11",equipment:"LUMIX S5",location:"Kyoto",description:"錦秋の京都。圧縮効果を使って、紅葉の密度を高める。赤、オレンジ、黄色の色彩のレイヤーが、視覚的な暖かさを与える。PLフィルターを使用し、葉の反射を抑えて本来の色を鮮やかに描写。"},{id:22,title:"Urban Geometry",category:"Cityscape",image:iU,height:"h-80",date:"2025.04",equipment:"LUMIX S5",location:"Tokyo",description:"ビルのファサード（正面）を切り取る。窓のグリッド、階段の螺旋、壁面のタイル。都市の中に潜む幾何学的なパターンを発見し、抽象画のように構成（Composition）する。"},{id:23,title:"Golden Hour Portrait",category:"Portrait",image:rU,height:"h-[450px]",date:"2024.08",equipment:"LUMIX S5",location:"Beach",description:"太陽が沈む直前の15分間。逆光のフレアを意図的に取り入れ、ノスタルジックな雰囲気に。風になびく髪の動きと、アンニュイな表情が、夏の終わりの切なさを物語る。"},{id:24,title:"Product Lighting",category:"Commercial",image:sU,height:"h-64",date:"2025.02",equipment:"LUMIX S5",location:"Studio",description:"高級時計のプロダクト撮影。金属の光沢とガラスの透明感を、多灯ライティングでコントロール。ミリ単位の光の調整が求められる、精密なブツ撮りの世界。"},{id:25,title:"Foggy Forest",category:"Nature",image:oU,height:"h-96",date:"2024.06",equipment:"LUMIX S5",location:"Nikko",description:"雨上がりの杉林。立ち込める霧の中を、ドローンで低空飛行し撮影。木々の間を縫うような視点は、鳥になったかのような浮遊感を与える。深い緑と白のコントラスト。"},{id:26,title:"Night Walker",category:"Cityscape",image:aU,height:"h-72",date:"2024.12",equipment:"LUMIX S5",location:"Shinjuku",description:"高感度ISO 12800での手持ち撮影。ノイズをあえて残し、フィルムのような粒子感（Grain）を演出。眠らない街のエネルギーと、そこに生きる人々の匿名性を表現。"},{id:27,title:"Traditional Craft",category:"Commercial",image:lU,height:"h-80",date:"2025.01",equipment:"LUMIX S5",location:"Workshop",description:"伝統工芸士の手元。使い込まれた道具の美しさ。職人の息遣いが聞こえてくるような距離感でのマクロ撮影。日本の「匠」の精神をビジュアル化するドキュメンタリーフォト。"},{id:28,title:"Aerial Coastline",category:"Nature",image:cU,height:"h-64",date:"2024.09",equipment:"LUMIX S5",location:"Izu",description:"断崖絶壁と打ち寄せる波。真上からの視点（Bird's-eye view）で見ると、海岸線は複雑なフラクタル模様を描いていることがわかる。自然の造形美をダイナミックに捉えた一枚。"},{id:29,title:"Emotion",category:"Portrait",image:uU,height:"h-[500px]",date:"2025.03",equipment:"LUMIX S5",location:"Indoor",description:"泣き顔、あるいは笑い顔。感情が溢れ出る瞬間を逃さずシャッターを切る。作り笑顔ではない、生身の人間が見せるリアルな感情の揺れ動きこそが、写真に魂を宿す。"},{id:30,title:"Cyber Tokyo",category:"Cityscape",image:fU,height:"h-72",date:"2025.02",equipment:"LUMIX S5",location:"Akihabara",description:"秋葉原の電気街。多重露光（Multiple Exposure）をカメラ内で合成し、情報の洪水とカオスを視覚化。現実とデジタルの境界が曖昧になった現代都市のメタファー。"},{id:31,title:"Zen Garden",category:"Nature",image:dU,height:"h-64",date:"2024.11",equipment:"LUMIX S5",location:"Kyoto",description:"枯山水。石と砂だけで表現された宇宙。ミニマルな構図の中に、無限の広がりを感じさせる。静寂（Silence）を撮る、というテーマへの挑戦。"},{id:32,title:"Automotive",category:"Commercial",image:hU,height:"h-80",date:"2025.04",equipment:"LUMIX S5",location:"Circuit",description:"スポーツカーの流し撮り。シャッタースピード1/30秒で、背景を流してスピード感を演出。車のボディラインの艶めかしさと、アスファルトの質感の対比。"},{id:33,title:"Cherry Blossom",category:"Nature",image:pU,height:"h-96",date:"2025.04",equipment:"LUMIX S5",location:"Meguro River",description:"桜の川。上空から見ると、ピンク色の帯が都市を貫いているように見える。春の訪れを祝う人々の賑わいを、俯瞰的な視点から優しく見守るような構図。"},{id:34,title:"Black & White Portrait",category:"Portrait",image:mU,height:"h-[450px]",date:"2024.10",equipment:"LUMIX S5",location:"Studio",description:"モノクロ専用機での撮影。光と影の階調（Gray Scale）だけで、人物の存在感を彫刻のように浮かび上がらせる。色彩に惑わされず、被写体の本質に迫る究極のポートレート。"},{id:35,title:"Festival Night",category:"Cityscape",image:xU,height:"h-64",date:"2024.08",equipment:"LUMIX S5",location:"Asakusa",description:"日本の夏祭り。提灯の明かりと、浴衣の人々。熱気と湿度まで写し込む。スローシンクロ撮影により、背景の動きと手前の被写体の静止を同居させ、祭りの動的なエネルギーを表現。"},{id:36,title:"Abstract Water",category:"Nature",image:gU,height:"h-72",date:"2025.05",equipment:"LUMIX S5",location:"River",description:"川面の波紋。光の屈折が生み出す抽象的な模様。具象的な対象物を撮りつつも、そこから意味を剥ぎ取り、純粋な色と形の美しさ（Abstract Beauty）として再構築した作品。"}],_U=[{title:"Standard Plan",price:"¥30,000~",description:`プロフィール写真、宣材写真、記念写真など。
